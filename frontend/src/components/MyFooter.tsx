  ...
  return (
    ...
    <div className="mt-[240px] md:mx-[70px]">
      <div className=" relative rounded-[20px] bg-primarycolor  min-w-[350px] -top-[160px] mx-2 md:mx-0   ">
        ...
        <div className=" relative grid md:grid-cols-6 grid-cols-3 -top-12  ">
        ...
        <div className="flex flex-col">
          <p className=" text-[color:var(--blackish-green,#121)] text-base  font-tradegothic  mb-[16px]  font-extrabold">
            {" "}
            Our Destinations
          </p>
          <p className="text-[color:var(--blackish-green,#121)] text-sm font-montserrat mb-[12px] ">
            Canada
          </p>
          <p className="text-[color:var(--blackish-green,#121)] text-sm font-montserrat mb-[12px] ">
            France
        ...
        <div className="flex flex-col">
          <p className=" text-[color:var(--blackish-green,#121)] text-base  font-tradegothic  mb-[16px] font-bold">
